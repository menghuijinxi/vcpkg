if(NOT _VCPKG_WINDOWS_TOOLCHAIN)
    ...
    set(Z_VCPKG_MSVC_RELEASE_DEBUG_FLAG "/Z7")
    if(DEFINED VCPKG_MSVC_RELEASE_DEBUG_INFO AND NOT VCPKG_MSVC_RELEASE_DEBUG_INFO STREQUAL "")
        if(VCPKG_MSVC_RELEASE_DEBUG_INFO STREQUAL "none")
            set(Z_VCPKG_MSVC_RELEASE_DEBUG_FLAG "")
        elseif(NOT VCPKG_MSVC_RELEASE_DEBUG_INFO STREQUAL "embedded")
            message(FATAL_ERROR "Invalid setting for VCPKG_MSVC_RELEASE_DEBUG_INFO: \"${VCPKG_MSVC_RELEASE_DEBUG_INFO}\". It must be \"embedded\" or \"none\".")
        endif()
    endif()

    set(CMAKE_CXX_FLAGS_RELEASE "${VCPKG_CRT_LINK_FLAG_PREFIX} /O2 /Oi /Gy /DNDEBUG ${Z_VCPKG_MSVC_RELEASE_DEBUG_FLAG} ${VCPKG_CXX_FLAGS_RELEASE}" CACHE STRING "")
    set(CMAKE_C_FLAGS_RELEASE "${VCPKG_CRT_LINK_FLAG_PREFIX} /O2 /Oi /Gy /DNDEBUG ${Z_VCPKG_MSVC_RELEASE_DEBUG_FLAG} ${VCPKG_C_FLAGS_RELEASE}" CACHE STRING "")
    ...
    unset(CHARSET_FLAG)
    unset(MP_BUILD_FLAG)
    unset(Z_VCPKG_MSVC_RELEASE_DEBUG_FLAG)
